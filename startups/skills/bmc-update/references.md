# references — bmc-update

The "BMC as a hypothesis sheet that evolves" pattern is from:

- **Osterwalder, Alexander & Pigneur, Yves.** *Business Model Generation.* Wiley, 2010.

Combined with the validated-learning loop in:
...
- `bmc-build` — initial canvas.
- `hypothesis-register` (hypothesis-tracking plugin) — source of the flips.
- `pivot-refine-log` — records the pivot decision when ≥ 2 cells change.
